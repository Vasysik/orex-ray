...
- объединять ручные профили в пользовательские группы; серверы подписок
  автоматически собираются в сворачиваемую группу своей подписки;
- менять порядок серверов drag-and-drop внутри текущей группы;
- переставлять сами группы долгим нажатием и перетаскиванием; порядок хранится вместе с профилями;
- при удалении ручной группы выбирать: оставить её профили без группы или удалить их вместе с группой;
...
и профили. Автообновление не держит постоянный фоновый таймер: при запуске
...
как информационные строки подписки (например, срок действия или остаток трафика).
...
группы и группы подписок, а также смешивать оба способа.
...
- автоматическими группами подписок и пользовательскими группами профилей, включая их порядок, удаление с содержимым и группированный быстрый выбор;
